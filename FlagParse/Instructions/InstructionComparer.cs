    ...
    public class InstructionComparer : IEqualityComparer<Instruction>
    {
        private class InstructionComparerFactory : InstructionVisitor<IEqualityComparer<Instruction>>
        {
            ...
            private class CallInlineComparer : InstructionComparer<CallInlineInstruction>
            {
                ...
                {
                    return a.Key == b.Key && SequenceComparer.Of(new InstructionComparer()).Equals(a.Instructions, b.Instructions);
                }

                protected override int GetHashCode(CallInlineInstruction obj)
                {
                    return obj.Key.GetHashCode() ^ SequenceComparer.Of(new InstructionComparer()).GetHashCode(obj.Instructions);
                }
            }
            ...
            private class LoopInlineComparer : InstructionComparer<LoopInlineInstruction>
            {
                ...
                {
                    return SequenceComparer.Of(new InstructionComparer()).Equals(a.Instructions, b.Instructions);
                }

                protected override int GetHashCode(LoopInlineInstruction obj)
                {
                    return SequenceComparer.Of(new InstructionComparer()).GetHashCode(obj.Instructions);
                }
            }
