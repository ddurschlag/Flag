...
Write(@" != null )
{
");if ( tArg.Template != null )
{
Template(tArg.Template);
}Write(@"
}
");
    }   
...
Write(@"(dynamic tArg) {
        ");if ( anon_0.Item2 != null )
{
Template(anon_0.Item2);
}Write(@"
    }   
...
{
Loop(anon_1.Loop);
}if ( anon_1.LoopInline != null )
{
LoopInline(anon_1.LoopInline);
}if ( anon_1.Call != null )
{
Call(anon_1.Call);
}if ( anon_1.CallInline != null )
{
CallInline(anon_1.CallInline);
}if ( anon_1.Output != null )
{
Output(anon_1.Output);
}if ( anon_1.Render != null )
{
Render(anon_1.Render);
}
}
    }   
...
Write(@" != null )
foreach ( var childElement in ");if ( tArg.ContextVariable != null )
{
Write(tArg.ContextVariable);
}
Write(@" ) {
...
Write(@");");
    ...
    public void Template(dynamic tArg) {
        if ( tArg.Instructions != null )
{
Instructions(tArg.Instructions);
}
    }   
